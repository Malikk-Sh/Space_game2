...
function zorpGraph(){
  ...
  return{type:'graph',start:'intro',speaker:'ЗОРП',nodes:{
    ...
    // ★ Phase 3.3: кросс-референс на Клирра — обогащённый repeat-узел
    repeat:{text:['ЗОРП:','Я УЖЕ НА БОРТУ - НЕ ОТВЛЕКАЙ.','...ШУТКА. Я ЗДЕСЬ. ПЕДАЛИ ЖДУ.','КЛИРР? ОН МНЕ КАК ОТЕЦ.','СКАЗАЛ - ИДИ, СЫНОК. Я И ПОШЁЛ.'],end:true},
  }};
}
function krokGraph(){
