...
function updIntro(G){
  ...
  if(s===11){
    ...
    const lines=[
      ...
      // ★ Phase 3.1: пришелец представляется — РАЙГАР
      ['ПРИШЕЛЕЦ:','МЕНЯ ЗОВУТ РАЙГАР. БЛАГОДАРЮ ТЕБЯ.'],     // 3
      ['ПИЛОТ:','КАК ТЫ ОКАЗАЛСЯ ЗДЕСЬ?'],                    // 4
      ['РАЙГАР:','...ЛУЧШЕ НЕ СПРАШИВАЙ.'],                   // 5
      ['РАЙГАР:','НАШУ СИСТЕМУ ЗАХВАТИЛ СИНДИКАТ.'],          // 6
      ['РАЙГАР:','ОНИ ЗАКОВАЛИ ЗВЕЗДУ В СФЕРУ.'],             // 7
      ['РАЙГАР:','НАЗЫВАЮТ ЕЁ - ТИНА.'],                      // 8
      ['ПИЛОТ:','А МИРЫ?'],                                   // 9
      ['РАЙГАР:','ЗАМЕРЗАЮТ. ОДИН ЗА ДРУГИМ.'],               // 10
...
function drwIntro(G){
  ...
  // ===== СЦЕНА 11: ДИАЛОГ В КОКПИТЕ (переработана) =====
    ...
    const lines=[
      ...
      // ★ Phase 3.1: пришелец представляется — РАЙГАР
      ['ПРИШЕЛЕЦ:','МЕНЯ ЗОВУТ РАЙГАР. БЛАГОДАРЮ ТЕБЯ.'],
      ['ПИЛОТ:','КАК ТЫ ОКАЗАЛСЯ ЗДЕСЬ?'],
      ['РАЙГАР:','...ЛУЧШЕ НЕ СПРАШИВАЙ.'],
      ['РАЙГАР:','НАШУ СИСТЕМУ ЗАХВАТИЛ СИНДИКАТ.'],
      ['РАЙГАР:','ОНИ ЗАКОВАЛИ ЗВЕЗДУ В СФЕРУ.'],
      ['РАЙГАР:','НАЗЫВАЮТ ЕЁ - ТИНА.'],
      ['ПИЛОТ:','А МИРЫ?'],
      ['РАЙГАР:','ЗАМЕРЗАЮТ. ОДИН ЗА ДРУГИМ.'],
      ['РАЙГАР:','ТЫ - НАША ПОСЛЕДНЯЯ НАДЕЖДА.'],
    ...
    if(cur&&cur[0]){
      ...
      // ★ Phase 3.1: подсветка реплик инопланетянина (ПРИШЕЛЕЦ или после интро — РАЙГАР)
      const isAlien=cur[0].startsWith('ПРИШЕЛЕЦ')||cur[0].startsWith('РАЙГАР');
